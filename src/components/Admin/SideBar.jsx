...
export default function SideBar() {
    ...
    return (
        <div className="d-flex flex-column flex-shrink-0 p-3 bg-light h-100" id="navbarNavAltMarkup">
                    ...
                    <li className="nav-item">
                        <a href="/admindash/customers" className={location.pathname === "/admindash/customers"? "nav-link active": "nav-link link-dark"} aria-current="page">
                        <svg className="bi me-2" width="16" height="16"><use href="#home"></use></svg>
                        Customers
                        </a>
                    </li>
